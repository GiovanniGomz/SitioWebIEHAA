...
class CarpetaComponent extends ComponentBase
{
    ...
    public function generarPDF()
    {
        ...
        \Log::info(json_encode($carpetas));

        $titulo = 'Listado de Carpetas de Gaveta #' . $gaveta->codigo;
        ...
        $pdf = Pdf::loadView('iehaa.carpetas::reporte', $data);

        return $pdf->download('reporte_carpeta.pdf');
    }
    ...
    public function generarExcel()
    {
        ...
        $url = get('id');
        $gaveta = Gaveta::where('url', $url)->first();
        $titulo = 'Carpetas de la Gaveta #' . $gaveta->codigo . ' IEHAA';
