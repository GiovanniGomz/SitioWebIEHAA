...
function avisoEliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.request('TipoPublicacionComponent::onEliminar', {
                data: { id: id },
...
function cargarFormulario(data) {
    const { tipo_publicacion } = data;

    modoModificar();

    document.querySelector('#nombre').value = tipo_publicacion.nombre;
    document.querySelector('#id').value = tipo_publicacion.id;
}
...
function modoModificar() {
    ...
    titulo.textContent = 'Modificar Tipo de Publicación';
...
function modoRegistrar() {
    ...
    titulo.textContent = 'Registrar Tipo de Publicación';
